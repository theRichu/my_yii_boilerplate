	...
	var getLocationName = function(position) {
		...
		_self.vars.geocoder.geocode({'latLng': latlng}, function(results, status) {
			if (status == google.maps.GeocoderStatus.OK && results[1]) {
				...
				var district = "N/A";
				        ...
				        for (var component in results[1]['address_components']) {
				            for (var i in results[1]['address_components'][component]['types']) {
				                if (results[1]['address_components'][component]['types'][i] == "country") {
				                	console.log(component);
				                	console.log(component-1);
				                	console.log(component-2);
				                	console.log(component-3);
				                	
				                	state = results[1]['address_components'][component-1]['short_name'];
				                    city = results[1]['address_components'][component-2]['short_name'];
				                    district = results[1]['address_components'][component-3]['short_name'];
				...
				$(_self.vars.cssID + ".gllpDistrict").val(district);
