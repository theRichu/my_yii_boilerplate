...
class RoomChargesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['RoomCharges'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('RoomCharges');
	...
	{
		$model=new RoomCharges('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['RoomCharges']))
			$model->attributes=$_GET['RoomCharges'];
	 ...
	 * @return RoomCharges the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=RoomCharges::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param RoomCharges $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='room-charges-form')
		{
